...
public interface BoardMapper {
	...
	@Insert("insert into content_table(content_subject, content_text, content_file,"
			...
			+ "values (#{content_subject}, #{content_text}, #{content_file, jdbcType=VARCHAR}, #{content_writer_idx}, "
			+ "#{content_board_idx}, now())")
	...
	@Select("select a2.user_name as content_writer_name, "
			+ "date_format(a1.content_date, '%Y-%m-%d') as content_date, "
			+ "a1.content_subject, a1.content_text, a1.content_file, a1.content_writer_idx, a1.content_idx "
			+ "from content_table a1, user_table a2 "
			+ "where a1.content_writer_idx = a2.user_idx "
